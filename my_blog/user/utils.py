...
from my_blog.settings import EMAIL_HOST_USER, MEDIA_ROOT
...
def upload_image(storeobj):
    access_key = 'QIDYtU109ehaJqPRzf0eBboaQMbcJLhwHxy5wOHL'
    secret_key = '7wB1tOXEMU-15-6wyl6Hd_QrJkP-1I2it4SxW_nn'
    ...
    save_path = 'http://q0foqp8j5.bkt.clouddn.com/'+filename
    return save_path
